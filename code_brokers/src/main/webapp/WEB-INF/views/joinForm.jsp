...
<article>
	<div class="content">
		<div><h3>회원가입</h3></div>
		<form action="/codeBrokers/join.cbs" method="post" id="joinForm">
			<div class="joinForm">
				<label>아이디</label>
				<input type="text" class="form-control"name="id" placeholder="영문 또는 숫자 6~12자">
				<label>비밀번호</label>
				...
				<label>닉네임</label>
				<input type="text" class="form-control" name="nickname" placeholder="한글 2~6자, 영문 6~12자">
				<label>메일링 가입</label>
